...
const registros_mantidos_tabela_leitura = 1000;
...
function registrar_leitura(temperatura, umidade, luminosidade) {
    ...
    banco.conectar().then(() => {
        ...
        INSERT into Sensores (Umidade, Temperatura, Luminosidade, dataHora)
        values (${umidade.toFixed(1)}, ${temperatura.toFixed(1)}, ${luminosidade}, CONVERT(Datetime, '${agora()}', 120));
